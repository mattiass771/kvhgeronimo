...
class CalendarRemoveSoldiersAdmin extends Component {
    constructor(props) {
        super(props)
        this.state = {
            soldier: "",
    ...
    handleChange = (event) => {
        ...
        axios.get(`https://kvhgeronimo.herokuapp.com/calendar/${this.props.calendarID}`)
            .then(response => {
                ...
                soldierArr.splice(soldierArr.indexOf(value),1)
    ...
    //PROPS: calendarID, soldierData, calendarSoldiers
...
export default CalendarRemoveSoldiersAdmin;