...
class LibraryAddModal extends Component {
    constructor() {
        super()
        this.state = {
            popup: true,
    ...
    addReport = () => {
        axios.post(`https://kvhgeronimo.herokuapp.com/library/add`, { links: this.state.links, name: this.state.name, isOpen: this.state.isOpen, text: this.state.text })
            .then(res => {
